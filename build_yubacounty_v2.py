...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/yubacounty"
...
def render_casefile(path,case,fields,stamp="UNSOLVED"):
    ...
    img.save(path)
CASES={
 "yc_file":("The Yuba County Five",[("Date","Feb 24, 1978"),("Location","Plumas Forest, California"),("Victims","5 men"),("Status","Never explained")]),
}
SFX=ROOT+"/assets/sfx"
...
SHORTS=[
 {"id":"yubacounty","speed":0.97,
  "hook":["Five men drove into","the mountains.","None came home."],
  "punch":"The car\nstill worked.","punch_beat":3,
  "cta":["What were they","running from?"],
  "beats":[
   ("In 1978, five young men left a basketball game to drive home. They were never seen alive again.",
    ["vid:dark mountain road at night headlights",f"img:{IMG}/yc_car.jpg"]),
   ("Days later, their car was found abandoned high in the snowy California mountains, far off the road home.",
    [f"img:{IMG}/yc_car.jpg","vid:snowy forest road winter"]),
   ("Here is everything investigators actually knew.",
    [f"card:{IMG}/yc_file.jpg"]),
   ("The car still worked. It had gas. Yet the men had left it and walked into the freezing wilderness on foot.",
    [f"img:{IMG}/yc_forest.jpg","vid:dark pine forest fog night"]),
   ("One body was later found in a ranger's trailer, nineteen miles away, stocked with food and heat they barely touched.",
    [f"img:{IMG}/yc_trailer.jpg","vid:cabin in snowy woods at night"]),
   ("Four of the five were found dead. The fifth was never found. Nothing has ever explained what drove them up that mountain.",
    ["vid:foggy dark forest winter","vid:snow falling dark forest"]),
 ]},
]
