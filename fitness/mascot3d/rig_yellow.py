...
BASE="/home/alpha/products/youtube-pipeline/fitness/mascot3d"; GLB=f"{BASE}/mascot_rigged.glb"; R=f"{BASE}/renders"
...
bpy.ops.wm.save_as_mainfile(filepath=f"{BASE}/mascot_rigged_yellow.blend")
...
sc.render.resolution_x=620; sc.render.resolution_y=840; sc.render.filepath=f"{R}/ym_rig.png"
