...
SHORTS=[
 {"id":"sodder","speed":0.97,
  "hook":["Five kids vanished.","No bones found."],
  "punch":"Too fast.\nToo clean.","punch_beat":2,
  "cta":["What happened to them?","Follow for more"],
  "beats":[
   ("On Christmas Eve, five children vanished in a house fire. Not a single bone was ever found.",
    [f"img:{IMG}/sd_house_fire.jpg",f"img:{IMG}/sd_xmas_dark.jpg"]),
   ("West Virginia, 1945. The parents escaped. Five kids upstairs did not.",
    [f"img:{IMG}/sd_house_fire.jpg",f"img:{IMG}/sd_snow_ruins.jpg"]),
   ("But the fire burned for only forty five minutes. Too fast, too clean.",
   ...
   ("Years later, a photo arrived in the mail, a man who looked just like their son.",
    [f"rimg:{REAL}/sd_louis.jpg",f"img:{IMG}/sd_mailbox.jpg"]),
   ("They searched for the rest of their lives. They never found them.",
