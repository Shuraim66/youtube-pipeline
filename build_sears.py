...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/sears/img"
...
SHORTS=[
 {"id":"sears","speed":1.05,
  "hook":["It sold houses by mail.","Then vanished."],
  "punch":"Even\nhouses.","punch_beat":1,
  "cta":["Adapt or die.","Follow for more"],
  "beats":[
   ("A hundred years before Amazon, one company let you order almost anything by mail, even an entire house. Then it vanished.",
    [f"img:{IMG}/sr_real_catalog.jpg",f"img:{IMG}/sr_dept_store.jpg"]),
   ("Sears was the everything store. Its catalog sold clothes, tools, cars, and build-it-yourself homes.",
    [f"img:{IMG}/sr_catalog.jpg",f"img:{IMG}/sr_kit_house.jpg"]),
   ("Millions ordered from it. Sears became the biggest retailer in the world.",
    [f"img:{IMG}/sr_real_store.jpg",f"img:{IMG}/sr_warehouse.jpg"]),
   ("Then the internet arrived. A company called Amazon did the same thing, faster.",
    [f"img:{IMG}/sr_shopper_online.jpg",f"img:{IMG}/sr_delivery_boxes.jpg"]),
   ("Sears had the catalog, the warehouses, the customers. But it refused to change.",
    [f"img:{IMG}/sr_warehouse.jpg",f"img:{IMG}/sr_boardroom.jpg"]),
   ("Its stores emptied. One by one, they closed.",
    [f"img:{IMG}/sr_empty_mall.jpg",f"img:{IMG}/sr_closing_sign.jpg"]),
   ("In 2018, Sears filed for bankruptcy. It invented ordering everything, and Amazon buried it.",
    [f"img:{IMG}/sr_faded_store.jpg",f"img:{IMG}/sr_shopper_online.jpg"]),
 ]},
]
def dl(url,dst):
