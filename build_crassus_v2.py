...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/crassus"
...
SHORTS=[
 {"id":"crassus","speed":1.05,
  "hook":["Richest man in Rome.","He let it burn."],
  "punch":"Sell...\nor burn.","punch_beat":2,
  "cta":["Fortune has a price.","Follow for more"],
  "beats":[
   ("The richest man in Rome made his fortune by letting the city burn.",
    [f"img:{REAL}/cr_bust.jpg",f"img:{IMG}/cr_fire.jpg",f"img:{IMG}/cr_rome.jpg"]),
   ("Crassus owned the only fire brigade in the entire city.",
    [f"img:{IMG}/cr_brigade.jpg",f"img:{IMG}/cr_villa.jpg"]),
   ("When your house caught fire, his men would show up, then refuse to lift a finger, unless you sold him the house for almost nothing.",
    [f"img:{IMG}/cr_crowd.jpg",f"img:{IMG}/cr_fire.jpg",f"img:{IMG}/cr_gold.jpg"]),
   ("Refuse, and they let it burn to the ground. He bought half of Rome this way, and became the richest man alive.",
    [f"img:{IMG}/cr_brigade.jpg",f"img:{IMG}/cr_gold.jpg",f"img:{IMG}/cr_senate.jpg"]),
   ("But greed dragged him to war, and his enemies poured molten gold down his throat, so the richest man could finally have his fill.",
    [f"img:{IMG}/cr_legion.jpg",f"img:{IMG}/cr_battle.jpg",f"img:{IMG}/cr_moltengold.jpg",f"img:{REAL}/cr_bust.jpg"]),
 ]},
]
