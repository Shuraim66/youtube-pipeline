...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/vanderbilt/img"
...
SHORTS=[
 {"id":"vanderbilt","speed":1.05,"hook":["Richest in America.","Broke in 50 years."],"punch":"It takes brains\nto keep it.","punch_beat":3,"cta":["Keeping it is the hard part.","Follow for more"],"beats":[
   ("This family built a fortune bigger than the entire U.S. Treasury. Fifty years later, not one of them was a millionaire.",
    [f"img:{IMG}/cornelius.jpg"]),
   ("It started with Cornelius Vanderbilt. Railroads made him the richest man in the world. He died in 1877 worth over a hundred million dollars.",
    [f"img:{IMG}/cornelius.jpg","vintage steam train railroad smoke"]),
   ("His son doubled it. But the grandchildren didn't build. They spent it, on marble mansions and lavish parties.",
    [f"img:{IMG}/william.jpg",f"img:{IMG}/breakers.jpg","opulent chandelier ballroom gold luxury"]),
   ("The Commodore had warned them: any fool can make a fortune. It takes brains to keep it. Nobody listened.",
    [f"img:{IMG}/cornelius.jpg","vintage gold coins money dark"]),
   ("By 1973, a hundred and twenty Vanderbilts gathered. Not one was a millionaire. America's greatest fortune, gone.",
    [f"img:{IMG}/william.jpg","opulent empty grand marble hall"]),
 ]},
]
def dl(url,dst):
