...
SHORTS=[
 {"id":"somerton","speed":0.97,
  ...
  "beats":[
   ...
   ("Every single label in his clothes had been cut out.",
    [f"img:{IMG}/so_cut_labels.jpg",f"img:{IMG}/so_suit.jpg"]),
   ("In a hidden pocket was a scrap of paper. It read: Tamam Shud. The end.",
    [f"rimg:{REAL}/so_scrap.jpg",f"img:{IMG}/so_suit.jpg"]),
   ("It was torn from a rare book of poems, found in a stranger's car.",
   ...
   ("He was buried as an unknown man. To this day, no one knows who he was.",
    [f"img:{IMG}/so_grave_unknown.jpg",f"img:{IMG}/so_pier_night.jpg",f"img:{IMG}/so_beach_dusk.jpg"]),
 ]},
]
