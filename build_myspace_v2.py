...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/myspace"
...
def genimg(name,prompt):
    ...
    STYLE=", cinematic still, dramatic moody lighting, 35mm film, highly detailed, vertical composition"
...
IMGPROMPTS={
 "ms_founders":"two confident young tech founders in an early 2000s startup office, bright daylight through windows, glossy magazine photo, high-key lighting, clear and vivid",
 "ms_crowd":"a bright glowing social network of connected faces and profile photos, luminous blue and white, clean modern render, vivid, well lit",
 "ms_screen":"a retro early-2000s computer monitor brightly lit showing a colorful busy social profile page, clean product photo, high-key",
 "ms_king":"stacks of hundred dollar bills and gold coins on a bright polished desk, luxury magazine photo, high-key studio lighting, vivid",
 "ms_ruins":"an empty modern office at dusk with one glowing monitor, cinematic but clearly visible, soft rim light, moody yet bright enough to read",
}
SFX=ROOT+"/assets/sfx"
...
SHORTS=[
 {"id":"myspace","speed":1.05,
  "hook":["It had 100 million","users. Then it","vanished."],
  "punch":"They sold it\nfor $580M.","punch_beat":3,
  "cta":["Nothing is forever.","Follow for more"],
  "beats":[
   ("Before Facebook, one website owned the entire internet. Then it vanished.",
    ["vid:modern data center servers glowing blue",f"img:{IMG}/ms_founders.jpg"]),
   ("It was MySpace. By 2006 it was the most visited site in America, bigger than Google.",
    ["vid:person scrolling phone screen close up","vid:city skyline day aerial"]),
   ("Over 100 million users. News Corp bought it for 580 million dollars.",
    ["vid:money cash counting close up",f"img:{IMG}/ms_king.jpg"]),
   ("But it got slow and cluttered, and a cleaner site was rising: Facebook.",
    ["vid:typing on laptop keyboard",f"img:{IMG}/ms_screen.jpg"]),
   ("In three years the users were gone. No empire is safe.",
    ["vid:empty abandoned office building",f"img:{IMG}/ms_ruins.jpg"]),
 ]},
]
