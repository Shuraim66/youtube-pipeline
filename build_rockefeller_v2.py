...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/rockefeller"
...
SHORTS=[
 {"id":"rockefeller","speed":1.05,
  "hook":["Richest American ever.","90% of all oil."],
  "punch":"$400\nbillion.","punch_beat":2,
  "cta":["Empires are built quietly.","Follow for more"],
  "beats":[
   ("At his peak, this man controlled ninety percent of America's oil, and became the richest American who ever lived.",
    [f"img:{REAL}/rk_portrait.jpg",f"img:{IMG}/rk_oil_field.jpg",f"img:{IMG}/rk_refinery.jpg"]),
   ("John D. Rockefeller built Standard Oil into an empire that powered the whole country.",
    [f"img:{IMG}/rk_barrels.jpg",f"img:{IMG}/rk_gas_station.jpg"]),
   ("He crushed every rival until he owned almost all of it, worth over four hundred billion in today's money.",
    [f"img:{IMG}/rk_money.jpg",f"img:{IMG}/rk_boardroom.jpg"]),
   ("The government called him a monopoly, and broke his company into pieces.",
    [f"img:{IMG}/rk_court.jpg",f"img:{IMG}/rk_broken.jpg"]),
   ("But splitting it only made him richer. The pieces became Exxon, Mobil, and Chevron.",
    [f"img:{IMG}/rk_gas_station.jpg",f"img:{IMG}/rk_stock.jpg"]),
   ("In his final years he gave most of it away, and handed dimes to strangers on the street.",
    [f"img:{IMG}/rk_dimes.jpg",f"img:{IMG}/rk_mansion.jpg"]),
   ("He reshaped America, and died the richest man it had ever seen.",
    [f"img:{IMG}/rk_tomb.jpg",f"img:{REAL}/rk_portrait.jpg"]),
 ]},
]
