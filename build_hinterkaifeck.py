...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/hinterkaifeck"
IMG=SCR+"/img"; REAL=SCR+"/real"; MUSIC=SCR+"/horror_bed.wav"
...
SHORTS=[
 {"id":"hinterkaifeck","speed":0.97,
  "hook":["Someone was living","in their attic."],
  "punch":"They never\nleft.","punch_beat":4,
  "cta":["Who was in the attic?","Follow for more"],
  "beats":[
   ("For days before this family was murdered, they heard footsteps in the attic. Someone was living up there.",
    [f"rimg:{REAL}/farmhouse.jpg",f"img:{IMG}/hk_ceiling_steps.jpg",f"img:{IMG}/hk_attic_dark.jpg"]),
   ("1922, a lonely farm in Bavaria. Footprints led through the snow to the house, but none led away.",
    [f"rimg:{REAL}/hof.jpg",f"img:{IMG}/hk_footprints_snow.jpg",f"img:{IMG}/hk_footprints_end.jpg"]),
   ("Keys vanished. A newspaper appeared. The farmer heard someone above him.",
    [f"img:{IMG}/hk_keys.jpg",f"img:{IMG}/hk_newspaper.jpg",f"img:{IMG}/hk_farmer_window.jpg"]),
   ("Days later, all six were found dead. Killed with a pickaxe.",
    [f"rimg:{REAL}/hof_crop.jpg",f"img:{IMG}/hk_pickaxe.jpg",f"img:{IMG}/hk_shadow_doorway.jpg"]),
   ("But the killer never left. They fed the animals. They cooked in the kitchen.",
    [f"img:{IMG}/hk_barn.jpg",f"img:{IMG}/hk_kitchen.jpg"]),
   ("Neighbors saw smoke from the chimney. Someone was living with the bodies.",
    [f"img:{IMG}/hk_chimney_smoke.jpg",f"img:{IMG}/hk_attic_eyes.jpg",f"img:{IMG}/hk_hallway.jpg"]),
   ("A century later, no one knows who was in that attic.",
    [f"img:{IMG}/hk_graves.jpg",f"rimg:{REAL}/farmhouse.jpg",f"img:{IMG}/hk_attic_eyes.jpg"]),
 ]},
]
