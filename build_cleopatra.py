...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/cleopatra/img"
...
SHORTS=[
 {"id":"cleopatra","speed":1.05,"hook":["Richest woman ever.","She drank a fortune."],"punch":"She drank\na fortune.","punch_beat":2,"cta":["Power has a price.","Follow for more"],"beats":[
   ("The richest woman in the ancient world once drank a fortune, just to win a bet.",
    [f"img:{IMG}/cl_queen.jpg",f"img:{IMG}/cl_palace.jpg"]),
   ("Cleopatra ruled Egypt, the wealthiest kingdom on Earth. Legend says she bet Mark Antony she could spend a fortune on a single dinner.",
    [f"img:{IMG}/cl_queen.jpg",f"img:{IMG}/cl_palace.jpg"]),
   ("So she took a pearl worth millions, dissolved it in a cup of vinegar, and drank it down. She won.",
    [f"img:{IMG}/cl_pearl.jpg",f"img:{IMG}/cl_queen.jpg"]),
   ("But her power made Rome her enemy. Her fleet was crushed at sea, and Egypt fell.",
    [f"img:{IMG}/cl_rome.jpg",f"img:{IMG}/cl_palace.jpg"]),
   ("The last queen of Egypt took her own life in 30 BC. All her gold couldn't save her throne.",
    [f"img:{IMG}/cl_fall.jpg",f"img:{IMG}/cl_queen.jpg"]),
 ]},
]
def dl(url,dst):
