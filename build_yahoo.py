...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/yahoo/img"
...
SHORTS=[
 {"id":"yahoo","speed":1.05,
  "hook":["Turned down $44 billion.","Sold for scraps."],
  "punch":"$44 billion.\nNo.","punch_beat":4,
  "cta":["Pride is expensive.","Follow for more"],
  "beats":[
   ("In 2008, Microsoft offered to buy Yahoo for forty four billion dollars. Yahoo said no. Nine years later, they sold for a fraction of that.",
    [f"img:{IMG}/yh_boardroom.jpg",f"img:{IMG}/yh_billion_cash.jpg"]),
   ("Yahoo was once the king of the internet, the most visited website on Earth.",
    [f"img:{IMG}/yh_office_90s.jpg",f"img:{IMG}/yh_search_crt.jpg"]),
   ("But Yahoo had a habit of saying no. In 2002, they tried to buy Google, then balked at the price.",
    [f"img:{IMG}/yh_garage.jpg",f"img:{IMG}/yh_reject.jpg"]),
   ("In 2006, they could have bought Facebook for a billion dollars. That deal fell through too.",
    [f"img:{IMG}/yh_dorm_startup.jpg",f"img:{IMG}/yh_reject.jpg"]),
   ("Then Microsoft came with forty four billion. Yahoo's CEO turned it down.",
    [f"img:{IMG}/yh_boardroom.jpg",f"img:{IMG}/yh_ceo_window.jpg"]),
   ("The internet moved on. Yahoo's value collapsed.",
    [f"img:{IMG}/yh_decline_chart.jpg",f"img:{IMG}/yh_server_room.jpg"]),
   ("In 2017, Yahoo sold for under five billion. Google and Facebook are now worth trillions.",
    [f"img:{IMG}/yh_glass_hq.jpg",f"img:{IMG}/yh_billion_cash.jpg",f"img:{IMG}/yh_ceo_window.jpg"]),
 ]},
]
def dl(url,dst):
