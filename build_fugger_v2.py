...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/fugger"
IMG=SCR+"/img"; REAL=SCR+"/real"; SFX=SCR+"/sfx"; MUSIC=QW+"/ep2/episode/music.wav"
...
SHORTS=[
 {"id":"fugger","speed":1.05,
  "hook":["Richer than Musk,","Bezos & Gates."],
  "punch":"2% of\nall Europe.","punch_beat":1,
  "cta":["Real wealth is quiet.","Follow for more"],
  "beats":[
   ("This man was richer than Elon Musk, Jeff Bezos, and Bill Gates, combined.",
    [f"img:{REAL}/fg_portrait.jpg",f"img:{IMG}/fg_gold_pile.jpg",f"img:{IMG}/fg_billionaire_sil.jpg"]),
   ("His name was Jakob Fugger. Five hundred years ago, he owned two percent of all Europe.",
    [f"img:{IMG}/fg_europe_map.jpg",f"img:{IMG}/fg_city_augsburg.jpg",f"img:{IMG}/fg_palace.jpg"]),
   ("Kings begged him for loans. He funded their wars, and bought a Pope his throne.",
    [f"img:{IMG}/fg_king_begging.jpg",f"img:{IMG}/fg_church_pope.jpg",f"img:{IMG}/fg_coins_table.jpg"]),
   ("When an emperor couldn't pay, Fugger reminded him who put him in power.",
    [f"img:{IMG}/fg_emperor.jpg",f"img:{IMG}/fg_letter_seal.jpg"]),
   ("At his peak, he was worth four hundred billion dollars in today's money.",
    [f"img:{IMG}/fg_gold_vault.jpg",f"img:{IMG}/fg_crown_gold.jpg"]),
   ("He wrote his own epitaph: second to none in the making of money.",
    [f"img:{IMG}/fg_grave.jpg",f"img:{REAL}/fg_portrait.jpg"]),
 ]},
]
