...
OUT=QW+"/shorts_b1"; os.makedirs(OUT,exist_ok=True)
...
SHORTS=[
 {"id":"announce","speed":0.72,"hook":["You can spot it","in 10 seconds."],"punch":"Real wealth\ndoesn't shout.","punch_beat":3,"cta":["7 things they never do","on the channel"],"beats":[
   ("You can spot someone who'll never be wealthy in about ten seconds. Not by their car. Not by their clothes. By one habit. They announce it.",
    ["flashy man talking loudly gesturing","luxury sports car showing off","designer logo brand clothes","man pointing bragging confident","man announcing showing off phone"]),
   ("The salary. The deal. The number. They can't wait to tell you, because being seen as rich matters more to them than being rich.",
    ["cash money counting hands","business handshake deal office","stack of money cash close","man boasting talking animated","man posing mirror flashy"]),
   ("But money that has to be announced isn't wealth. It's a costume.",
    ["empty flashy luxury showroom","mannequin suit shop window"]),
   ("Ask the quietly wealthy what they make, and you get a shrug and a change of subject. The number simply isn't for you.",
    ["calm man plain sweater serious","man shrug gesture indifferent","two men talking cafe calm","closed door quiet privacy"]),
   ("The loudest person in the room is almost never the richest. He just needs you to think he is.",
    ["loud crowd party bokeh night","quiet unnoticed man in crowd","confident man posing fake smile"]),
   ("So next time someone tells you how well they're doing, notice who in the room said nothing.",
    ["man bragging dinner table talking","quiet observant man watching calm"]),
 ]},
 {"id":"time","speed":0.80,"hook":["It looks lazy.","It's genius."],"punch":"You can't\nmake more time.","punch_beat":2,"cta":["How they spend","full video on the channel"],"beats":[
   ("The wealthy spend money on something that looks like pure laziness, and it's the smartest money they ever spend. They pay to delete tasks. The cleaning, the errands, the admin, the commute.",
    ["person relaxing calm on sofa","calm wealthy man thinking window","person handing over task delegating","cleaning home wiping surface","paperwork errands mail desk","busy traffic commute cars road"]),
   ("To most people that feels wasteful. It's the opposite.",
    ["person hesitant thinking about money","calm confident man slight nod"]),
   ("Because money, you can always make more of. Time, you can't make a single extra minute of. Every hour you buy back is an hour returned to your life.",
    ["cash money growing stack","clock ticking close up","hourglass sand flowing slow","calm person free morning coffee"]),
   ("Researchers even found people who spend to save time are happier than people who spend on stuff.",
    ["happy relaxed person smiling calm","cluttered pile of objects stuff"]),
   ("The wealthy figured it out early. Stop buying things to impress people. Start buying hours to be free.",
    ["luxury shopping bags street","calm free person walking morning","peaceful person by window light"]),
 ...
 {"id":"plain","speed":0.82,"hook":["The richer they are,","the plainer they look."],"punch":"Seen   vs.   Forgotten","punch_beat":2,"cta":["Which one are you becoming?","full video on the channel"],"beats":[
   ("The richer someone actually is, the more ordinary they usually look. Walk through a genuinely wealthy neighbourhood and it's strange. The cars are clean but plain, the clothes excellent, but you can't name a single brand on them.",
    ["ordinary man plain clothes walking","old money neighbourhood houses street","clean plain sedan car driveway","fine plain wool coat fabric","plain shirt no logo close up"]),
   ("That's not an accident. Quiet money pays for quality, the thing that lasts twenty years, and refuses to pay for the logo, the part that just tells strangers a price.",
    ["leather craftsmanship hands making","worn quality leather bag old","tailor stitching wool fabric close","luxury logo boutique window"]),
   ...
   ("The most-cited study of real millionaires found most of them drove used cars, and never spent much on a watch in their lives.",
    ["older man modest used car","modest suburban home ordinary","bare wrist no watch hands"]),
   ("The people who look rich, and the people who are rich, two almost completely different groups.",
    ["flashy man vs plain man street","quiet ordinary man walking city"]),
...
for S in SHORTS:
    ...
    seg[-1][2]=vend
    tail=max(2.6, 61.5-vend); total=vend+tail
