"""Quiet Wealth — Shorts Batch 3: HOOK-FIRST rebuild (~32-35s, retention-optimized).
3-second-hook rules baked in: frame-0 BIG BOLD text HARD-ON (no fade, readable silent), punchy first visual,
then settle into calm b-roll. Each VO beat split into ~2.5s word-matched sub-clips.
Output: shorts_b3/short_{boring,salary,rule}.mp4"""
...
OUT=QW+"/shorts_b3"; os.makedirs(OUT,exist_ok=True)
...
SHORTS=[
 {"id":"boring","speed":0.85,"hook":["Getting rich","is BORING."],"punch":"Boring is winning.","punch_beat":2,"cta":["Boredom is the strategy.","Follow for more"],"beats":[
   ("If your life's getting boring, you might be getting rich.",
    ["wild party crowd celebrating night lights","calm man quiet morning routine coffee"]),
   ("No drama. No chaos. The same quiet routine, every single day.",
    ["calm man morning coffee window","minimal quiet tidy room morning light"]),
   ("Everyone else is chasing excitement. The wealthy are chasing boredom, because boring means it's working.",
    ["excited crowd nightlife party","calm focused man working alone desk"]),
   ("Exciting money habits make you broke. Boring ones make you rich. They just do it so slowly nobody notices.",
    ["flashy fast spending shopping","slow steady savings growth chart calm"]),
   ("So if it feels like nothing's happening, that's the sound of everything working.",
    ["calm content man window dusk","peaceful quiet morning routine coffee"]),
 ]},
 {"id":"salary","speed":0.85,"hook":["Your salary","is the trap."],"punch":"Own, don't earn.","punch_beat":2,"cta":["Stop selling your hours.","Follow for more"],"beats":[
   ("Your salary will never make you rich. And you already know it.",
    ["hand counting cash money close up","empty wallet no money open"]),
   ("A salary pays you for your time. And you only get so many hours.",
    ["office worker watching clock time","tired person working long hours late"]),
   ("The wealthy stopped selling hours. They own things that pay them while they sleep.",
    ["person sleeping peacefully at night","rental property real estate building"]),
   ("That's the whole difference. Money that stops the second you stop, versus money that shows up without you.",
    ["money passive income growing chart","calm wealthy man relaxing home"]),
   ("The goal was never a bigger paycheck. It was not needing one.",
    ["calm free man morning no work","peaceful person financial freedom window"]),
 ]},
 {"id":"rule","speed":0.85,"hook":["The 24-hour","rule."],"punch":"You won't even want\nit tomorrow.","punch_beat":2,"cta":["Sleep on it.","Follow for more"],"beats":[
   ("Rich people wait 24 hours before any big purchase.",
    ["finger hovering buy now button phone","laptop closing calmly desk"]),
   ("Because every expensive mistake gets made in a mood. Excited, insecure, or trying to impress someone.",
    ["impulse online shopping excited","stressed person holding credit card"]),
   ("Sleep on it, and the excitement drains out. Half of what you almost bought, you won't even want tomorrow.",
    ["person sleeping calm night bed","empty online shopping cart screen"]),
   ("They make big decisions slowly, and small ones fast. The exact opposite of everyone else.",
    ["calm thoughtful man deciding","fast checkout payment card store"]),
   ("The purchase that can't wait a day is almost always the one you can't afford.",
    ["calm man walking away from store","thoughtful person window morning light"]),
 ]},
]
def dl(url,dst):
