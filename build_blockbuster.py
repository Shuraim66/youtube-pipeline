...
SHORTS=[
 {"id":"blockbuster","speed":1.05,
  "hook":["They could've owned","Netflix for $50M."],
  "punch":"They said\nNO.","punch_beat":3,
  "cta":["Money can't fix bad calls.","Follow for more"],
  "beats":[
   ("In 2000, a tiny startup called Netflix begged Blockbuster to buy them for fifty million dollars. They laughed them out of the room.",
    [f"img:{IMG}/bl_pitch.jpg",f"img:{IMG}/bl_laugh.jpg"]),
   ("Blockbuster was a giant. Nine thousand stores, millions of members.",
    [f"img:{IMG}/bl_store_night.jpg",f"img:{IMG}/bl_real_store.jpg"]),
   ("Netflix was broke, mailing DVDs in little red envelopes.",
    [f"img:{IMG}/bl_startup_office.jpg",f"img:{IMG}/bl_real_envelope.jpg"]),
   ("So Blockbuster said no. Their late fees were printing cash.",
    [f"img:{IMG}/bl_laugh.jpg",f"img:{IMG}/bl_cash.jpg"]),
   ("But customers hated late fees. So Netflix killed them, then launched streaming.",
    [f"img:{IMG}/bl_angry_receipt.jpg",f"img:{IMG}/bl_streaming.jpg"]),
   ("By 2010, Blockbuster was bankrupt. Its stores went dark, one by one.",
    [f"img:{IMG}/bl_closing.jpg",f"img:{IMG}/bl_liquidation.jpg"]),
   ("Today Netflix is worth two hundred billion dollars. The deal of the century, turned down for free.",
    [f"img:{IMG}/bl_glass_hq.jpg",f"img:{IMG}/bl_stock.jpg",f"img:{IMG}/bl_deal.jpg"]),
 ]},
]
def dl(url,dst):
