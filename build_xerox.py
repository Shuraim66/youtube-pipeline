...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/xerox/img"
...
SHORTS=[
 {"id":"xerox","speed":1.05,
  "hook":["Xerox invented it all.","Then gave it away."],
  "punch":"He took\nit all.","punch_beat":4,
  "cta":["Ideas are worthless alone.","Follow for more"],
  "beats":[
   ("Xerox invented the personal computer, the mouse, and the screen you're reading this on. Then they gave it all away.",
    [f"img:{IMG}/xr_real_alto.jpg",f"img:{IMG}/xr_gui_screen.jpg",f"img:{IMG}/xr_real_mouse.jpg"]),
   ("In the 1970s, Xerox built the future in a secret lab. Windows, icons, a mouse. Decades ahead.",
    [f"img:{IMG}/xr_lab_70s.jpg",f"img:{IMG}/xr_gui_screen.jpg"]),
   ("But Xerox only cared about selling copy machines. The bosses ignored it.",
    [f"img:{IMG}/xr_copier.jpg",f"img:{IMG}/xr_executives.jpg"]),
   ("Then a young Steve Jobs came to visit. They showed him everything.",
    [f"img:{IMG}/xr_visitor_lab.jpg",f"img:{IMG}/xr_gui_screen.jpg"]),
   ("Jobs walked out, built the Macintosh, and changed the world.",
    [f"img:{IMG}/xr_personal_computer.jpg",f"img:{IMG}/xr_idea_glow.jpg"]),
   ("Xerox made billions on copiers, and missed the biggest industry in history.",
    [f"img:{IMG}/xr_money_copier.jpg",f"img:{IMG}/xr_empty_chair.jpg"]),
   ("They invented the future, and handed it to someone else.",
    [f"img:{IMG}/xr_museum.jpg",f"img:{IMG}/xr_stock_soar.jpg",f"img:{IMG}/xr_faded_hq.jpg"]),
 ]},
]
def dl(url,dst):
