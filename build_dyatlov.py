...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/dyatlov"
...
SHORTS=[
 {"id":"dyatlov","speed":0.97,
  "hook":["They ran barefoot","into the snow."],
  "punch":"Cut from\ninside.","punch_beat":2,
  "cta":["What did they see?","Follow for more"],
  "beats":[
   ("In 1959, nine experienced hikers cut their way out of their tent and ran into a frozen night. They were never seen alive again.",
    [f"img:{IMG}/dy_tent_snow.jpg",f"img:{IMG}/dy_tent_cut.jpg",f"img:{IMG}/dy_footprints.jpg"]),
   ("They were crossing the Ural mountains in Russia. Skilled, prepared, careful.",
    [f"img:{IMG}/dy_mountain_night.jpg",f"img:{IMG}/dy_forest_night.jpg"]),
   ("Weeks later, searchers found their tent, sliced open from the inside.",
    [f"rimg:{REAL}/dy_tent.jpg",f"img:{IMG}/dy_shapes_snow.jpg"]),
   ("The hikers were scattered in the snow, a mile away, some barely dressed.",
    [f"img:{IMG}/dy_footprints.jpg",f"img:{IMG}/dy_boots.jpg",f"img:{IMG}/dy_campfire.jpg"]),
   ("Two had crushed chests. One was missing her tongue. Their clothes were radioactive.",
    [f"img:{IMG}/dy_shapes_snow.jpg",f"img:{IMG}/dy_forest_night.jpg"]),
   ("Whatever drove them out, they chose the freezing dark over staying inside.",
    [f"img:{IMG}/dy_lights_sky.jpg",f"img:{IMG}/dy_mountain_night.jpg"]),
   ("Sixty years later, no one knows what was out there that night.",
    [f"img:{IMG}/dy_tent_snow.jpg",f"img:{IMG}/dy_lights_sky.jpg",f"img:{IMG}/dy_tent_cut.jpg"]),
 ]},
]
