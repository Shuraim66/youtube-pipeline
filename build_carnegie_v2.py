...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/carnegie"
...
SHORTS=[
 {"id":"carnegie","speed":1.05,
  "hook":["Richest man alive.","Gave it all away."],
  "punch":"Dying rich\nis a disgrace.","punch_beat":3,
  "cta":["Legacy over money.","Follow for more"],
  "beats":[
   ("This man became the richest in the world, then spent the rest of his life desperately trying to give it all away.",
    [f"img:{REAL}/ca_portrait.jpg",f"img:{IMG}/ca_steel_mill.jpg",f"img:{IMG}/ca_money.jpg"]),
   ("Andrew Carnegie came from nothing and built an empire of steel that forged modern America.",
    [f"img:{IMG}/ca_workers.jpg",f"img:{IMG}/ca_city.jpg",f"img:{IMG}/ca_bridge.jpg"]),
   ("He sold it for the equivalent of over three hundred billion dollars, becoming the richest man alive.",
    [f"img:{IMG}/ca_money.jpg",f"img:{IMG}/ca_mansion.jpg"]),
   ("But Carnegie believed that dying rich was a disgrace.",
    [f"img:{IMG}/ca_ledger.jpg",f"img:{IMG}/ca_sunset_estate.jpg"]),
   ("So he gave it away, thousands of libraries, universities, and concert halls.",
    [f"img:{IMG}/ca_library.jpg",f"img:{IMG}/ca_crowd.jpg"]),
   ("He gave away ninety percent of his fortune before he died.",
    [f"img:{IMG}/ca_giving.jpg",f"img:{REAL}/ca_portrait.jpg"]),
   ("He said: the man who dies rich, dies disgraced.",
    [f"img:{IMG}/ca_tomb.jpg",f"img:{IMG}/ca_library.jpg"]),
 ]},
]
