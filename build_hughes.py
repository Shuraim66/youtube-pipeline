...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/hughes/img"
...
# brighter/punchier grade for the FIRST frame so it pops in the feed (fix for high early swipe)
...
SHORTS=[
 {"id":"hughes","speed":1.05,"hook":["He had everything.","He ended like this."],"punch":"Money couldn't\nsave his mind.","punch_beat":4,"cta":["All the money in the world.","Follow for more"],"beats":[
   ("The richest man in America died so unrecognizable, they could only identify him by his fingerprints.",
    [f"img:{IMG}/hu_peak.jpg",f"img:{IMG}/hu_plane.jpg"]),
   ("Howard Hughes had it all. A film studio, an airline, world speed records. The most famous man in America.",
    [f"img:{IMG}/hu_glamour.jpg",f"img:{IMG}/hu_plane.jpg"]),
   ("But his mind was unraveling. A crippling fear of germs slowly turned into total isolation.",
    [f"img:{IMG}/hu_dark.jpg",f"img:{IMG}/hu_glamour.jpg"]),
   ("He sealed himself in dark rooms, grew his hair and nails long, and stored his own urine in jars.",
    [f"img:{IMG}/hu_jars.jpg",f"img:{IMG}/hu_dark.jpg"]),
   ("The richest man in the world wasted away to ninety pounds, alone. All his money couldn't save his mind.",
    [f"img:{IMG}/hu_end.jpg",f"img:{IMG}/hu_peak.jpg"]),
 ]},
]
def dl(url,dst):
