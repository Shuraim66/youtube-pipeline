...
SHORTS=[
 {"id":"viddemo","speed":0.97,
  "hook":["The ocean keeps","its secrets."],
  "punch":"Without a\ntrace.","punch_beat":1,
  "cta":["What's down there?","Follow for more"],
  "beats":[
   ("The ocean has swallowed entire ships without a trace for centuries.",
    ["vid:dark stormy ocean night","vid:huge ocean waves"]),
   ("Vast, cold, and impossibly deep, it hides whatever it takes.",
    ["vid:deep dark underwater","vid:foggy sea"]),
   ("Sailors vanish, and the water keeps its secrets.",
    ["vid:dark ocean horizon","vid:stormy sea waves"]),
   ("The sea never gives back what it claims.",
    ["vid:crashing waves dark","vid:ocean storm"]),
 ]},
]
