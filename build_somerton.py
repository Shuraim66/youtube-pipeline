...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/somerton"
...
SHORTS=[
 {"id":"somerton","speed":0.97,
  "hook":["A dead man,","and a secret code."],
  "punch":"TAMAM SHUD.\nThe end.","punch_beat":2,
  "cta":["Who was he?","Follow for more"],
  "beats":[
   ("In 1948, a man was found dead on a beach, in a pressed suit, with no ID. No one has ever identified him.",
    [f"img:{IMG}/so_beach_dusk.jpg",f"img:{IMG}/so_seawall_figure.jpg"]),
   ("He leaned against the sea wall as if asleep. Every label on his clothes had been cut out.",
    [f"img:{IMG}/so_cut_labels.jpg",f"img:{IMG}/so_suit.jpg"]),
   ("In a hidden pocket, police found a scrap of paper. It read: Tamam Shud. The end.",
    [f"rimg:{REAL}/so_scrap.jpg",f"img:{IMG}/so_suit.jpg"]),
   ("It was torn from a rare book of poems. The book was found in a stranger's car.",
    [f"img:{IMG}/so_old_book.jpg",f"img:{IMG}/so_car_book.jpg"]),
   ("Inside was a code that no one has ever cracked.",
    [f"img:{IMG}/so_cipher.jpg",f"img:{IMG}/so_old_book.jpg"]),
   ("He was buried as an unknown man. No name, no story.",
    [f"img:{IMG}/so_grave_unknown.jpg",f"img:{IMG}/so_pier_night.jpg"]),
   ("To this day, we still don't know who the Somerton Man was.",
    [f"img:{IMG}/so_grave_unknown.jpg",f"img:{IMG}/so_beach_dusk.jpg",f"img:{IMG}/so_seawall_figure.jpg"]),
 ]},
]
