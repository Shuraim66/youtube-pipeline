...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/croesus/img"
...
SHORTS=[
 {"id":"croesus","speed":1.05,"hook":["Richest king ever.","'Rich as Croesus.'"],"punch":"Call no man happy\nuntil he is dead.","punch_beat":4,"cta":["Rich as Croesus.","Follow for more"],"beats":[
   ("This king was so rich that 2,500 years later, we still say 'rich as Croesus.'",
    [f"img:{IMG}/cr_king.jpg",f"img:{IMG}/cr_gold.jpg"]),
   ("Croesus ruled Lydia, and his land sat on rivers of gold. He minted the world's first pure gold coins.",
    [f"img:{IMG}/cr_coins.jpg",f"img:{IMG}/cr_gold.jpg"]),
   ("Convinced he was unstoppable, Croesus marched to war against the mighty Persian Empire.",
    [f"img:{IMG}/cr_army.jpg",f"img:{IMG}/cr_king.jpg"]),
   ("He lost everything in one campaign. In 546 BC, the Persians took his gold, his kingdom, and his throne.",
    [f"img:{IMG}/cr_fall.jpg",f"img:{IMG}/cr_army.jpg"]),
   ("The richest man alive lost it all. As the old warning goes: call no man happy, until he is dead.",
    [f"img:{IMG}/cr_fall.jpg",f"img:{IMG}/cr_king.jpg"]),
 ]},
]
def dl(url,dst):
