...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/toysrus"
...
def render_card(path,big,label,sub=""):
    ...
    img.save(path)
CARDS={
 "c_debt":("$6.6B","in debt after the buyout","2005 leveraged buyout"),
 "c_interest":("$400M","a year, just in interest","money that couldn't be reinvested"),
}
SFX=ROOT+"/assets/sfx"
...
SHORTS=[
 {"id":"toysrus","speed":1.03,
  "hook":["Toys R Us didn't","die from Amazon."],
  "punch":"The DEBT\nkilled it.","punch_beat":4,
  "cta":["It's rarely the rival.","Follow for more"],
  "beats":[
   ("Toys R Us didn't die because of Amazon. It died because of one decision made in a boardroom.",
    ["vid:colorful toy store shelves",f"img:{IMG}/tr_store.jpg"]),
   ("In 2005, investors took it private in a leveraged buyout, piling 6.6 billion dollars of debt onto the company itself.",
    [f"card:{IMG}/c_debt.jpg","vid:business meeting handshake office"]),
   ("Servicing that debt cost around 400 million dollars every year, just in interest.",
    [f"card:{IMG}/c_interest.jpg"]),
   ("So while Amazon and Walmart modernized, Toys R Us couldn't. Almost every dollar went to lenders, not to its stores.",
    ["vid:amazon warehouse packages conveyor","vid:online shopping laptop"]),
   ("By 2017 it collapsed, and around 30,000 people lost their jobs. The stores still had customers. The debt is what killed it.",
    [f"img:{IMG}/tr_empty.jpg","vid:closed store shutter"]),
   ("The lesson: it's rarely the competition that ends a company. It's the debt they were buried under.",
    ["vid:money dollars counting","vid:empty shopping mall"]),
 ]},
]
