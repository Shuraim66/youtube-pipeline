...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/flight19"
...
SHORTS=[
 {"id":"flight19","speed":0.97,
  "hook":["5 planes vanished.","So did the rescue."],
  "punch":"Vanished\ntoo.","punch_beat":5,
  "cta":["What's out there?","Follow for more"],
  "beats":[
   ("In 1945, five Navy planes took off over the ocean and vanished. The rescue plane sent to find them vanished too.",
    [f"img:{IMG}/fl_planes_dusk.jpg",f"img:{IMG}/fl_ocean_storm.jpg"]),
   ("It was a routine training flight off the coast of Florida.",
    [f"img:{IMG}/fl_cockpit.jpg",f"img:{IMG}/fl_search_plane.jpg"]),
   ("Then the lead pilot radioed that his compasses had stopped working, and the ocean looked wrong.",
    [f"img:{IMG}/fl_compass.jpg",f"img:{IMG}/fl_radio_room.jpg"]),
   ("They flew in circles for hours, lost, as their fuel ran out.",
    [f"img:{IMG}/fl_map.jpg",f"img:{IMG}/fl_waves_night.jpg"]),
   ("Then the radio went silent. Fourteen men, gone.",
    [f"img:{IMG}/fl_empty_sea.jpg",f"img:{IMG}/fl_fog_sea.jpg"]),
   ("A giant rescue plane launched to find them. Minutes later, it vanished without a trace.",
    [f"img:{IMG}/fl_search_plane.jpg",f"img:{IMG}/fl_radar.jpg"]),
   ("No wreckage was ever found. It became the heart of the Bermuda Triangle legend.",
    [f"img:{IMG}/fl_sunset_empty.jpg",f"img:{IMG}/fl_ocean_storm.jpg"]),
 ]},
]
