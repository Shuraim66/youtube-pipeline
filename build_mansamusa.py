...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/mansamusa/img"
...
SHORTS=[
 {"id":"mansamusa","speed":1.05,"hook":["Too rich to measure.","He broke gold."],"punch":"No one has ever\nbeen richer.","punch_beat":4,"cta":["Still the richest ever.","Follow for more"],"beats":[
   ("The richest man in history gave away so much gold, he accidentally crashed its value across a whole region.",
    [f"img:{IMG}/catalan.jpg",f"img:{IMG}/mm_gold.jpg"]),
   ("Mansa Musa, emperor of Mali, 700 years ago. His land held so much gold, his fortune was too vast to count.",
    [f"img:{IMG}/mm_throne.jpg",f"img:{IMG}/mm_gold.jpg"]),
   ("In 1324, he crossed the desert to Mecca with sixty thousand people and camels loaded with gold.",
    [f"img:{IMG}/mm_caravan.jpg",f"img:{IMG}/mm_gold.jpg"]),
   ("Passing through Cairo, he gave away so much gold that its price collapsed there for years.",
    [f"img:{IMG}/mm_gold.jpg",f"img:{IMG}/mm_throne.jpg"]),
   ("He filled Timbuktu with libraries and scholars. And no one has ever been richer since.",
    [f"img:{IMG}/mm_timbuktu.jpg",f"img:{IMG}/catalan.jpg"]),
 ]},
]
def dl(url,dst):
