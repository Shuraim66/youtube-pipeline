...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/morgan"
...
SHORTS=[
 {"id":"morgan","speed":1.05,
  "hook":["He locked the richest","men in a room."],
  "punch":"He BECAME\nthe bank.","punch_beat":3,
  "cta":["Power is quiet.","Follow for more"],
  "beats":[
   ("One man locked the richest men in America in his library and refused to let them leave. Outside, the whole country was about to collapse.",
    [f"img:{REAL}/jm_portrait.jpg",f"img:{IMG}/jm_meeting.jpg",f"img:{IMG}/jm_panic.jpg"]),
   ("His name was J.P. Morgan, the most powerful banker who ever lived.",
    [f"img:{IMG}/jm_office.jpg",f"img:{IMG}/jm_wallst.jpg"]),
   ("Banks were failing. People stormed the streets to pull out their money.",
    [f"img:{IMG}/jm_panic.jpg",f"img:{IMG}/jm_headline.jpg"]),
   ("There was no federal reserve, no government bailout. So Morgan became the bank.",
    [f"img:{IMG}/jm_gold.jpg",f"img:{IMG}/jm_capitol.jpg"]),
   ("He locked the richest men in America in his library and refused to let them leave until they put up the money to stop the panic.",
    [f"img:{IMG}/jm_meeting.jpg",f"img:{IMG}/jm_money.jpg"]),
   ("It worked. He personally halted a collapse that could have destroyed the country.",
    [f"img:{IMG}/jm_railroad.jpg",f"img:{IMG}/jm_bank.jpg"]),
   ("One man, richer than the government itself. Because in 1907, the economy was collapsing, and one man saved it.",
    [f"img:{IMG}/jm_cigar.jpg",f"img:{REAL}/jm_portrait.jpg"]),
 ]},
]
