"""Aurelis business-story short — Kodak. HOOK-FIRST narrated (energetic VO + AI stills).
DENSE word-matched visuals: 15 phrase-matched Flux stills, one per phrase, ~2.5s cuts (no reuse).
Frame-0 bold hook + bright GRADE_OPEN first frame. Output: prototypes/short_kodak.mp4"""
...
SHORTS=[
 {"id":"kodak","speed":1.05,
  "hook":["They invented digital.","Then buried it."],
  "punch":"They buried\nit.","punch_beat":3,
  "cta":["Fear of change kills giants.","Follow for more"],
  "beats":[
   ("In 1975, a young Kodak engineer invented the world's first digital camera. His bosses took one look and told him to bury it.",
    [f"img:{IMG}/kd_engineer.jpg",f"img:{IMG}/kd_bosses.jpg"]),
   ("Kodak ruled photography. Ninety percent of the film, most of the cameras in America.",
    [f"img:{IMG}/kd_film_factory.jpg",f"img:{IMG}/kd_film_rolls.jpg"]),
   ("But a digital photo needs no film. And film was Kodak's golden goose.",
    [f"img:{IMG}/kd_shutter.jpg",f"img:{IMG}/kd_golden_goose.jpg"]),
   ("So they hid the invention away. Why kill the thing printing billions?",
    [f"img:{IMG}/kd_locked.jpg",f"img:{IMG}/kd_film_rolls.jpg"]),
   ("The world went digital without them. Then phone cameras killed film for good.",
    [f"img:{IMG}/kd_digital_world.jpg",f"img:{IMG}/kd_phone_camera.jpg"]),
   ("In 2012, Kodak filed for bankruptcy. Its factories went silent.",
    [f"img:{IMG}/kd_bankruptcy.jpg",f"img:{IMG}/kd_empty_factory.jpg"]),
   ("They held the future in their hands in 1975, and chose the past.",
    [f"img:{IMG}/kd_future_hands.jpg",f"img:{IMG}/kd_past_road.jpg",f"img:{IMG}/kd_hq_decline.jpg"]),
 ]},
]
def dl(url,dst):
