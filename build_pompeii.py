...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/pompeii"
...
SHORTS=[
 {"id":"pompeii","speed":1.05,"hook":["Buried alive","in one afternoon."],"punch":"Frozen where\nthey fell.","punch_beat":3,"cta":["Frozen in time.","Follow for more"],"beats":[
   ("In 79 AD, an entire Roman city was buried alive in one afternoon.",
    [f"img:{IMG}/pompeii1.jpg",f"img:{IMG}/pompeii2.jpg"]),
   ("Mount Vesuvius erupted. A cloud of ash, hundreds of degrees hot, killed thousands in seconds.",
    [f"img:{IMG}/pompeii2.jpg",f"img:{IMG}/pompeii3.jpg"]),
   ("Pompeii vanished under nearly twenty feet of ash, forgotten for almost 1,700 years.",
    [f"img:{IMG}/pompeii4.jpg"]),
   ("When they finally dug it out, they found the people, frozen exactly where they fell.",
    [f"img:{IMG}/pompeii5.jpg",f"img:{IMG}/pompeii6.jpg"]),
   ("A whole world, stopped in a single afternoon.",
    [f"img:{IMG}/pompeii7.jpg"]),
 ]},
]
def dl(url,dst):
