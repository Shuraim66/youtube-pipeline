...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/dancingplague"
...
SHORTS=[
 {"id":"dancingplague","speed":0.97,
  "hook":["Hundreds danced","until they died."],
  "punch":"Danced\nto death.","punch_beat":3,
  "cta":["What caused it?","Follow for more"],
  "beats":[
   ("In 1518, hundreds of people danced in the streets until they died. And no one knows why.",
    [f"rimg:{REAL}/dp_engraving.jpg",f"img:{IMG}/dp_dancers.jpg"]),
   ("It started with one woman in Strasbourg, dancing alone, unable to stop.",
    [f"img:{IMG}/dp_lone_dancer.jpg",f"img:{IMG}/dp_square.jpg"]),
   ("Within days, dozens joined her. Then hundreds, dancing without music, without rest.",
    [f"img:{IMG}/dp_crowd_grow.jpg",f"img:{IMG}/dp_night_dance.jpg"]),
   ("They danced for days. Their feet bled. Some had heart attacks and strokes.",
    [f"img:{IMG}/dp_shoes.jpg",f"img:{IMG}/dp_collapse.jpg"]),
   ("The authorities were baffled. So they built a stage and hired musicians, thinking it would help.",
    [f"img:{IMG}/dp_physician.jpg",f"img:{IMG}/dp_church.jpg"]),
   ("It made it worse. More people danced, and more of them died.",
    [f"img:{IMG}/dp_shadows.jpg",f"img:{IMG}/dp_collapse.jpg"]),
   ("To this day, no one can explain it. In 1518, hundreds danced in the streets until they died, and no one knows why.",
    [f"img:{IMG}/dp_graves.jpg",f"rimg:{REAL}/dp_engraving.jpg"]),
 ]},
]
