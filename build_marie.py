...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/marie/img"
...
SHORTS=[
 {"id":"marie","speed":1.05,"hook":["She spent while","France starved."],"punch":"She never said\n'let them eat cake.'","punch_beat":2,"cta":["The price of excess.","Follow for more"],"beats":[
   ("While France starved, its queen was spending a fortune on diamonds, gowns, and endless parties.",
    [f"img:{IMG}/ma_starving.jpg",f"img:{IMG}/ma_queen.jpg"]),
   ("Marie Antoinette. They called her Madame Deficit, as she gambled and spent while the country went bankrupt.",
    [f"img:{IMG}/ma_queen.jpg",f"img:{IMG}/ma_diamonds.jpg"]),
   ("Everyone remembers 'let them eat cake.' But she almost certainly never said it. It was invented to make people hate her.",
    [f"img:{IMG}/ma_queen.jpg",f"img:{IMG}/ma_versailles.jpg"]),
   ("It didn't matter. The people had decided, and the revolution came for the crown.",
    [f"img:{IMG}/ma_revolution.jpg",f"img:{IMG}/ma_starving.jpg"]),
   ("In 1793, the most extravagant queen in history lost her head to the guillotine.",
    [f"img:{IMG}/ma_guillotine.jpg",f"img:{IMG}/ma_queen.jpg"]),
 ]},
]
def dl(url,dst):
