...
SCR="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/roanoke"
...
SHORTS=[
 {"id":"roanoke","speed":0.97,
  "hook":["A colony vanished.","One word remained."],
  "punch":"CROATOAN.","punch_beat":5,
  "cta":["Where did they go?","Follow for more"],
  "beats":[
   ("An entire colony of over a hundred people vanished without a trace, leaving one word carved into a tree.",
    [f"img:{IMG}/ro_colony.jpg",f"img:{IMG}/ro_carving.jpg"]),
   ("In 1587, English settlers built a colony on Roanoke Island in America.",
    [f"img:{IMG}/ro_ships.jpg",f"img:{IMG}/ro_settlement.jpg"]),
   ("Their leader sailed back to England for supplies. War stranded him for three years.",
    [f"img:{IMG}/ro_ship_sea.jpg",f"img:{IMG}/ro_storm.jpg"]),
   ("When he finally returned, the entire colony was gone. Every house, every person.",
    [f"img:{IMG}/ro_empty_village.jpg",f"img:{IMG}/ro_fog.jpg"]),
   ("No bodies. No signs of battle. No graves.",
    [f"img:{IMG}/ro_empty_field.jpg",f"img:{IMG}/ro_woods.jpg"]),
   ("Only one clue: the word CROATOAN, carved into a wooden post.",
    [f"img:{IMG}/ro_carving.jpg",f"img:{IMG}/ro_post.jpg"]),
   ("Four hundred years later, no one knows what happened to the lost colony of Roanoke.",
    [f"img:{IMG}/ro_woods_dark.jpg",f"img:{IMG}/ro_colony.jpg"]),
 ]},
]
