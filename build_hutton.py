...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/hutton/img"
...
SHORTS=[
 {"id":"hutton","speed":1.05,"hook":["A billion-dollar heiress.","She died with $3,000."],"punch":"It never bought\nher love.","punch_beat":3,"cta":["Money couldn't buy love.","Follow for more"],"beats":[
   ("She inherited over a billion dollars, and died with just three thousand to her name.",
    [f"img:{IMG}/bh_glam.jpg",f"img:{IMG}/bh_lonely.jpg"]),
   ("Barbara Hutton, the Woolworth heiress. At 21, the richest girl in the world. The poor little rich girl.",
    [f"img:{IMG}/bh_glam.jpg",f"img:{IMG}/bh_palace.jpg"]),
   ("She married seven times, mostly princes and counts who wanted her money, spending fortunes on jewels and palaces.",
    [f"img:{IMG}/bh_couple.jpg",f"img:{IMG}/bh_jewels.jpg"]),
   ("One by one they took what they could and left. All her money never bought the love she chased.",
    [f"img:{IMG}/bh_couple.jpg",f"img:{IMG}/bh_lonely.jpg"]),
   ("When she died in 1979, the billion-dollar heiress had three thousand dollars left. And no one.",
    [f"img:{IMG}/bh_end.jpg",f"img:{IMG}/bh_glam.jpg"]),
 ]},
]
def dl(url,dst):
