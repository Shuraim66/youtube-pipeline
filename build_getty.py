...
IMG="/tmp/claude-1000/-home-alpha-products-youtube-pipeline/d26cef8b-33f8-460d-a296-387d6471b220/scratchpad/getty/img"
...
SHORTS=[
 {"id":"getty","speed":1.05,"hook":["Richest man alive.","He refused to pay."],"punch":"One penny.\n14 kidnappings.","punch_beat":2,"cta":["The cost of being cheap.","Follow for more"],"beats":[
   ("When his 16-year-old grandson was kidnapped, the richest man in the world refused to pay a single cent.",
    [f"img:{IMG}/getty_man.jpg",f"img:{IMG}/getty_rome.jpg"]),
   ("This was J. Paul Getty. Billions in oil, and so cheap he put a payphone in his own mansion for guests.",
    [f"img:{IMG}/getty_payphone.jpg",f"img:{IMG}/getty_man.jpg"]),
   ("The kidnappers wanted seventeen million. Getty's answer: pay one penny, and I'll have fourteen kidnapped grandchildren.",
    [f"img:{IMG}/getty_money.jpg",f"img:{IMG}/getty_man.jpg"]),
   ("So they cut off the boy's ear and mailed it to a newspaper. Only then did Getty pay.",
    [f"img:{IMG}/getty_news.jpg",f"img:{IMG}/getty_rome.jpg"]),
   ("And even then, he paid only what he could write off on his taxes, and lent the rest to his son, with interest.",
    [f"img:{IMG}/getty_money.jpg",f"img:{IMG}/getty_man.jpg"]),
 ]},
]
def dl(url,dst):
